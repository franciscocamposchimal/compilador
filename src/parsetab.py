...
_lr_productions = [
  ("S'",1,None,None,None),
  ('program',1,'p_program','analizadorSintactico.py',24),
  ('block',4,'p_block','analizadorSintactico.py',29),
  ('constDecl',3,'p_constDecl','analizadorSintactico.py',34),
  ('constDecl',1,'p_constDeclEmpty','analizadorSintactico.py',39),
